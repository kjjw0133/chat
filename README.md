...
#### 오류
+ 현재 버튼에서 Button3.Enabled := False;로 버튼의 사용을 막았는데, 처음 프로그램을 실행하고 로그인할 떄는 입장만 버튼 활성화, 생성은 비활성화 상태인데, 로그아웃을 하면, 입장이 비활성화, 생성은 활성화가 되는 상황이 일어난다. 일단 로그인을 하지 않으면 사용하지 못하도록 코드를 수정했음
